  ...
  return (
    <div className="w-full px-[220px] pt-[60px] pb-[220px]">
      <div className="flex items-center justify-between border-b-2 border-gray-100 pb-5">
        ...
        <Link
          href="/market/revenue"
          className="flex h-[60px] w-[440px] items-center justify-center gap-[10px] rounded-[2px] bg-[var(--main)] text-[18px] font-bold !text-black text-[color:var(--black)] transition hover:opacity-90"
        >
          나의 포토카드 판매하기 →
        </Link>
      </div>
