...
function isNewCard(acquiredAt) {
  ...
  const diff = Date.now() - new Date(acquiredAt).getTime();
    ...
    >
      ...
      <div style={{ padding: "12px 14px" }}>
        ...
        <div className="flex justify-between">
          <span style={{ color: "rgba(255,255,255,0.35)", fontSize: "11px" }}>보유 수량</span>
          <span style={{ color: "#fff", fontSize: "11px", fontWeight: "600" }}>{card.quantity}장</span>
        </div>
      </div>
    </div>
  );
...
export default function MyCardsPage() {
  ...
  const totalQuantity = useMemo(() =>
    cards.reduce((sum, c) => sum + (c.quantity || 0), 0), [cards]);
          ...
          <div className="flex items-center justify-center gap-2 mt-12 mb-8">
            <button
              ...
              style={{
                ...
                opacity: currentPage === 1 ? 0.3 : 1, fontSize: "16px",
              }}
            >‹</button>
            ...
            <button
              ...
              style={{
                ...
                opacity: currentPage === totalPages ? 0.3 : 1, fontSize: "16px",
              }}
            >›</button>
          </div>
        )}
